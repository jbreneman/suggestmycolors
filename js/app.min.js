...
"use strict";function hex2rgb(e){var t=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(e);return t?{r:parseInt(t[1],16),g:parseInt(t[2],16),b:parseInt(t[3],16),rgb:parseInt(t[1],16)+", "+parseInt(t[2],16)+", "+parseInt(t[3],16)}:null}function componentToHex(e){var t=e.toString(16);return 1==t.length?"0"+t:t}function rgbToHex(e,t,o){return"#"+componentToHex(e)+componentToHex(t)+componentToHex(o)}function zeroTo255(e){return e>255&&(e-=255,e>255&&(e=zeroTo255(e))),0>e&&(e+=255,0>e&&(e=zeroTo255(e))),e}function mutateColor(e,t,o,r,n,i,c){for(var l=hex2rgb(e),a={r:t+n,g:o+n,b:r+n},d={r:a.r,g:a.g,b:a.b},u="",s=1;i>=s;s++){var h="";h=c===!0?rgbToHex(t>0?255-l.r:l.r,o>0?255-l.g:l.g,r>0?255-l.b:l.b):rgbToHex(zeroTo255(l.r+a.r),zeroTo255(l.g+a.g),zeroTo255(l.b+a.b)),u+='<div class="color" style="background: '+h+'"><a href="index.html'+h+'">'+h+"</a></div>",a={r:a.r+d.r,g:a.g+d.g,b:a.b+d.b}}return u}function printColors(){return'<div class="column"><h2>Opposites</h2>'+mutateColor(hex,255,0,0,0,1,!0)+mutateColor(hex,0,255,0,0,1,!0)+mutateColor(hex,0,0,255,0,1,!0)+mutateColor(hex,255,255,0,0,1,!0)+mutateColor(hex,0,255,255,0,1,!0)+mutateColor(hex,255,0,255,0,1,!0)+mutateColor(hex,255,255,255,0,1,!0)+'</div><div class="column"><h2>Half Opposites</h2>'+mutateColor(hex,128,-32,0,0,1,!1)+mutateColor(hex,0,128,-32,0,1,!1)+mutateColor(hex,-32,0,128,0,1,!1)+mutateColor(hex,128,128,0,0,1,!1)+mutateColor(hex,0,128,128,0,1,!1)+mutateColor(hex,128,0,128,0,1,!1)+mutateColor(hex,128,128,128,0,1,!1)+'</div><div class="column"><h2>Red Shift</h2>'+mutateColor(hex,32,0,0,0,7,!1)+'</div><div class="column"><h2>Green Shift</h2>'+mutateColor(hex,0,32,0,0,7,!1)+'</div><div class="column"><h2>Blue Shift</h2>'+mutateColor(hex,0,0,32,0,7,!1)+"</div>"}function isValidHex(e){var t=/^#[0-9A-F]{6}$/i.test(e);return t?e:"#577d06"}var hex=isValidHex(window.location.hash),color=document.getElementById("color"),pick=document.getElementById("pick"),header=document.getElementById("headwrap"),headAnchor=header.getElementsByClassName("head-anchor"),slider=document.getElementById("slider"),picker=document.getElementById("picker"),output=document.getElementById("outputs"),sliderIndicator=document.getElementById("slider-indicator"),pickerIndicator=document.getElementById("picker-indicator");color.innerHTML="",ColorPicker.fixIndicators(sliderIndicator,pickerIndicator);var cp=new ColorPicker(slider,picker,function(e,t,o,r,n){ColorPicker.positionIndicators(document.getElementById("slider-indicator"),document.getElementById("picker-indicator"),n,r),color.innerHTML="<p>"+e+"</p>",header.style.backgroundColor=e;for(var i=0;i<headAnchor.length;++i)headAnchor[i].style.color=t.v>.6&&t.s<.6?"#000":"#fff";pick.style.backgroundColor=e,hex=e,output.innerHTML=printColors()});cp.setHex(hex),picker.addEventListener("mouseup",function(){window.location.hash=hex}),window.addEventListener("hashchange",function(){hex=isValidHex(window.location.hash),output.innerHTML=printColors(),cp.setHex(hex)}),document.getElementById("about-anchor").addEventListener("click",function(e){e.preventDefault(),document.getElementById("about").style.display="block"}),document.getElementById("close").addEventListener("click",function(){document.getElementById("about").style.display="none"});